...
<head>
	...
	<!-- Stylesheets
	============================================= -->
	<link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400italic,600,700,900|Playfair+Display:400,700&display=swap" rel="stylesheet" type="text/css" />
	...
	<div id="wrapper" class="clearfix">
					...
					<div class="header-row">
						...
						<nav class="primary-menu">
							...
							<ul class="menu-container one-page-menu custom-spacing" data-easing="easeInOutExpo" data-speed="1250" data-offset="0">
								...
								<li class="menu-item"><a class="menu-link" href="#" data-href="#section-about"><i class="icon-line2-user"></i><div>About</div></a></li>
								<li class="menu-item"><a class="menu-link" href="#" data-href="#section-works"><i class="icon-line2-grid"></i><div>Portfolio</div></a></li>
								<li class="menu-item"><a class="menu-link" href="#" data-href="#section-articles"><i class="icon-line2-pencil"></i><div>Articles</div></a></li>
								<li class="menu-item"><a class="menu-link" href="#" data-href="#footer"><i class="icon-line2-envelope"></i><div>Contact</div></a></li>
							</ul>
		...
		<section id="content" class="bg-transparent">
			<div class="content-wrap pb-0 bg-transparent">
				...
				<div id="section-about" class="section page-section m-0" style="background: #EEE url('{{ asset('/images/sections/1.jpg') }}') no-repeat center center; background-size: cover; padding: 100px 0">
					<div class="container">
						<div class="row">
							<div class="col-md-5 offset-md-7 clearfix">
								...
								<a href="#" class="button button-large button-border button-black button-dark ml-0"><i class="icon-line-cloud-download"></i> Download CV</a>
							</div>
						</div>
					</div>
				...
				<div id="section-works" class="section page-section m-0" style="background: #EEE url('{{ asset('/images/sections/2.jpg') }}') no-repeat center right; background-size: cover; padding: 100px 0">
					<div class="container">
						<div class="row">
								...
								<div class="row clearfix">
									<div class="col-md-6">
										<ul class="niche-demos-lists mb-0 lists-1">
											<li class="mt-0"><a href="demo-restaurant.html"><img src="{{ asset('/images/intro/niche/restaurant.jpg') }}" alt="Image">Restaurant Demo</a></li>
											<li><a href="demo-photography.html"><img src="{{ asset('/images/intro/niche/photography.jpg') }}" alt="Image">Photography</a></li>
											<li><a href="demo-medical.html"><img src="{{ asset('/images/intro/niche/medical.jpg') }}" alt="Image">Medical</a></li>
											<li><a href="demo-spa.html"><img src="{{ asset('/images/intro/niche/spa.jpg') }}" alt="Image">Spa</a></li>
											<li><a href="demo-coffee.html"><img src="{{ asset('/images/intro/niche/coffee.jpg') }}" alt="Image">Coffee</a></li>
											<li><a href="demo-interior-design.html"><img src="{{ asset('/images/intro/niche/interior-design.jpg') }}" alt="Image">Interior Design</a></li>
											<li><a href="demo-barber.html"><img src="{{ asset('/images/intro/niche/barber.jpg') }}" alt="Image">Barber</a></li>
										</ul>
									</div>
									<div class="col-md-6">
										<ul class="niche-demos-lists mb-0 lists-2">
											<li><a href="demo-travel.html"><img src="{{ asset('/images/intro/niche/travel.jpg') }}" alt="Image">Travel</a></li>
											<li><a href="demo-media-agency.html"><img src="{{ asset('/images/intro/niche/media-agency.jpg') }}" alt="Image">Media Agency</a></li>
											<li><a href="demo-construction.html"><img src="{{ asset('/images/intro/niche/construction.jpg') }}" alt="Image">Construction</a></li>
											<li><a href="demo-writer.html"><img src="{{ asset('/images/intro/niche/writer.jpg') }}" alt="Image">Writer</a></li>
											<li><a href="demo-real-estate.html"><img src="{{ asset('/images/intro/niche/real-estate/1.jpg') }}" alt="Image">Real Estate</a></li>
											<li><a href="demo-business.html"><img src="{{ asset('/images/intro/niche/business.jpg') }}" alt="Image">Business</a></li>
											<li><a href="demo-app-landing.html"><img src="{{ asset('/images/intro/niche/app-landing.jpg') }}" alt="Image">App Landing</a></li>
										</ul>
									</div>
								</div>
								<a href="#" class="button button-large button-border button-black button-dark topmargin-sm ml-0"><i class="icon-line-stack-2"></i> See More Works</a>
							</div>
						</div>
					</div>
					<div class="video-wrap">
						...
						<div id="posts" class="post-grid row gutter-30 mb-0" data-layout="fitRows">
								...
								<div class="grid-inner">
									<div class="entry-box-shadow">
										<div class="entry-image mb-0">
											<a href="images/blog/full/17.jpg" data-lightbox="image"><img src="{{ asset('/images/blog/1.jpg') }}" alt="Standard Post with Image"></a>
										</div>
							...
							<div class="entry col-md-6 col-lg-4">
								<div class="grid-inner">
									<div class="entry-box-shadow">
										<div class="entry-image mb-0">
											<a href="images/blog/full/17.jpg" data-lightbox="image"><img src="{{ asset('/images/blog/2.jpg') }}" alt="Standard Post with Image"></a>
										</div>
										<div class="entry-meta-wrapper">
											<div class="entry-meta mt-0">
												<a href="#" class="text-muted">March 25th, 2021</a>
							...
							<div class="entry col-md-6 col-lg-4">
								<div class="grid-inner">
									<div class="entry-box-shadow">
										<div class="entry-image mb-0">
											<a href="images/blog/full/17.jpg" data-lightbox="image"><img src="{{ asset('/images/blog/3.jpg') }}" alt="Standard Post with Image"></a>
										</div>
										<div class="entry-meta-wrapper">
											<div class="entry-meta mt-0">
												<a href="#" class="text-muted">March 25th, 2021</a>
			...
			<div class="container clearfix">
				...
				<div class="footer-widgets-wrap clearfix" style="padding: 80px 0">
					...
					<div class="row col-mb-50">
						<div class="col-lg-3">
							<div class="footer-logo"><span class="font-weight-normal color ls1" style="font-size: 22px; ">SemiColonWeb.</span><br><small class="ls3 text-uppercase" style="color: rgba(255,255,255,0.2);">&copy; 2020 Reserved.</small></div>
						</div>
